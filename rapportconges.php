...
.close-button {
  ...
  <body>
    ...
    <div class="card" id="leaveRequest">
      <h2>nouvelle demande de congé</h2>
      <p>Veuillez remplir le formulaire ci-dessous pour signaler votre absence.</p>

      <!-- Type de maladie -->
      <h3 for="leave-type">Type de congé :</h3>
      <form method="GET" action="demandes_conges1.php">
    <input type="hidden" name="utilisateur_id" value="<?php echo $utilisateur_id; ?>">
      <select name="type_conge"id="leave-type" class="conge">
        <option value=""disabled selected>Sélectionner</option>
        <option value="congé">Congé déduit</option>
        <option value="annual-leave">Congé annuel</option>
        <option value="study-leave">Congé d'études</option>
        <option value="volunteering">Bénévolat</option>
        <option value="" disabled>Congé non déduit</option>
        <option value="bereavement">Congé de deuil</option>
        <option value="jury-service">Service de jury</option>
        <option value="maternity-leave">Congé de maternité</option>
        <option value="offsite-meeting">Réunion à distance</option>
        <option value="parental-leave">Congé parental</option>
        <option value="paternity-leave">Congé de paternité</option>
      ...
      <div class="retour_travail">
        <input type="checkbox" name="retour_travail" value="1" id="returned" class="retour"/>
